...
// с этим типом техники - подтверждено построчным сравнением автоматической и ручной выгрузки
// за август (найдено 5 заказов на 600 000 ₽, отсутствующих в авто-отчёте, все "Машина
// прикрытия" - см. retrospectives/2026-08-15). Влад дополнительно нашёл и выгрузил все такие
// заказы за июнь-июль (5 шт, 123 000 ₽) - "прикрывашки.xlsx". Влад попросил взять загрузку
// файлов на себя (устал вручную грузить файлы в Таблицы и искать функции) - данные обоих
// файлов вшиты прямо в код (уже распарсены локально), запускать нужно только эту одну
// функцию. ВАЖНО: Влад собирается поменять "Тип техники" на Трал/Длинномер в самой 1С -
// после этого отчёт, возможно, начнёт подхватывать такие заказы сам (неизвестно, был ли
// именно тип техники причиной исключения из отчёта, или что-то другое - не проверено, это
// гипотеза Влада). Если проблема повторится в будущем (заказы с "Машина прикрытия" снова
// не попадают в авто-отчёт) - это тот же корень, нужна такая же разовая доливка вручную.
function importPrikrytieAndAugustFix_2026_08_15() {
  ...
  var PRIKR_ROWS = [
    ['Ахтамова Лиана 8-903-726-85-42','08. БУЛЬДОГ ООО','Машина прикрытия','','Кан Михаил Дмитриевич +7(926) 933-22-03','','LADA LARGUS Р048ЕТ797','Толмачев Александр Васильевич','КОМБИНАТ ИННОВАЦИОННЫХ ТЕХНОЛОГИЙ - МОНАРХ ООО','Бабушкинская - Марушкино','ДОГОВОР ПЕРЕВОЗКИ № 2703/ЛА-1 от 01.03.2026','04.06.2026','04.06.2026',1.5,'Нет',0,'Смена','','Нет','          ','',12000,'','',1,18000,18000,'Безналичный',1.5,'','','','','','','','','','','0','00БП-005313','Ахтамова Лиана 8-903-726-85-42','Нет','Нет','000466992',18000],
    ['Филипчук Екатерина Васильевна','08. БУЛЬДОГ ООО','Машина прикрытия','','Кан Михаил Дмитриевич +7(926) 933-22-03','','Лада Гранта О 946 МТ 797','Харабарь Денис','АРДЕНА БАЛТИК ЛОГИСТИКС ООО (Филипчук)','Московская область, городской округ Серпухов, город Протвино, улица Железнодорожная, д 5к1  Московская область, Сергиево-Посадский городской округ, Хот','','15.06.2026','15.06.2026',1,'Да',-452500,'Смена','','Нет','          ','М1.1-12000х3450х3800 — 18т.¶М2.1-12000х2440х3800 — 14т.¶М3.1-12000х3450х3800 — 22т.¶М4.1-12000х3450х',39000,'','',1,39000,39000,'Безналичный',1,'','','','','','','','','','','0','00БП-005817','Филипчук Екатерина Васильевна','Нет','Нет','000467749',39000],
    ['Ахтамова Лиана 8-903-726-85-42','08. БУЛЬДОГ ООО','Машина прикрытия','','Сильчев Максим Александрович 7 985 647-98-86','','Лада Гранта О 946 МТ 797','Харабарь Денис','КОМБИНАТ ИННОВАЦИОННЫХ ТЕХНОЛОГИЙ - МОНАРХ ООО','Марушкино - Бабушкинская','','26.06.2026','26.06.2026',2,'Нет',0,'Рейс','','Нет','          ','',12500,'','',1,25000,25000,'Безналичный',2,'','','','','','','','','','','0','00БП-005313','Ахтамова Лиана 8-903-726-85-42','Нет','Нет','000468807',25000],
    ['Филипчук Екатерина Васильевна','08. БУЛЬДОГ ООО','Машина прикрытия','','Махура Николай Геннадьевич +7 989 581 8582','','','','ТРЕЙДСЕРВИС ООО 7724441323','пр-т Вернадского, д. 76Б    - г. Люберцы, ул. Котельнический проезд, 26','','01.07.2026','01.07.2026',1,'Нет',28000,'Смена','','Нет','          ','"ГАБАРИТЫ СТРЕЛЫ: ¶Длина - 19 м.¶Ширина - 1,2 м.¶Высота: 1,5 м.¶Вес: 19 т."',21000,'','',1,21000,21000,'Безналичный',1,'','','','','','','','','','','0','00БП-006009','Филипчук Екатерина Васильевна','Нет','Нет','000469223',21000],
    ['Цегельников Вячеслав Владимирович 8-968-861-01-62','08. БУЛЬДОГ ООО','Машина прикрытия','','Махура Николай Геннадьевич +7 989 581 8582','','Лада Гранта О 946 МТ 797','Харабарь Денис','ВПЛ ООО','терминал нкт ( Подольск , рязановское шоссе 7а) - терминал депо Купавна ( старая Купавна ул дорожная 29 )','','13.07.2026','13.07.2026',1,'Нет',0,'Смена','','Нет','          ','',20000,'','','',20000,20000,'Безналичный',1,'','','','','','','','','','','0','','Ахтамова Лиана 8-903-726-85-42','Нет','Нет','000470206',20000]
  ];

  // "АВГУСТ РУЧНАЯ ВЫГРУЗКА.xlsx" - только 5 заказов, отсутствовавших в авто-отчёте (найдены
  // построчным сравнением с "Отчёт Таблица заказов")
  var AUG_MISSING_ROWS = [
    ['Махура Николай Геннадьевич +7 989 581 8582','08. БУЛЬДОГ ООО','Машина прикрытия','','Махура Николай Геннадьевич +7 989 581 8582','','LADA LARGUS Р131ЕТ797','Харабарь Денис','КРАНМАСТЕР ООО (НАШ)','Куусинена-Кржижановского','','07.08.2026','07.08.2026',1,'Нет',-13393000,'Смена','','Нет','          ','XCMG 70т 0742МН 50','','','','','','','Прочее',1,'',480,'','','','','','','','','0','','Махура Николай Геннадьевич +7 989 581 8582','Нет','Нет','000472070',''],
    ['Савиток Олеся Анатольевна 8-985-150-11-85','08. БУЛЬДОГ ООО','Машина прикрытия','','Сильчев Максим Александрович 7 985 647-98-86','','LADA LARGUS Р048ЕТ797','Толмачев Александр Васильевич','ВЕНТРАНС ООО ТЛК (ИНН 7817333232!!!)','Красногорский р-н, ЖК Опалиха парк - парк Горького','','10.08.2026','10.08.2026',2,'Нет',-990000,'Смена','','Нет','          ','','','','','','','','Прочее',2,'',480,'','','','','','','','','0','','Сильчев Максим Александрович 7 985 647-98-86','Нет','Нет','000472492',''],
    ['Ахтамова Лиана 8-903-726-85-42','08. БУЛЬДОГ ООО','Машина прикрытия','','Прус-Роскошный Роман Владимирович','','LADA LARGUS Р048ЕТ797','Толмачев Александр Васильевич','МТК ООО (АЛ)','Михнево - 5-й квартал Нагатина, район Нагатинский Затон, Южный административный округ, Москва','','12.08.2026','12.08.2026',1,'Нет',145000,'Смена','','Нет','          ','кран XCMG XGC100T','','','','','','','Прочее',1,'','','','','','','','','','','0','','Сильчев Максим Александрович 7 985 647-98-86','Нет','Нет','000472493',''],
    ['Савиток Олеся Анатольевна 8-985-150-11-85','08. БУЛЬДОГ ООО','Машина прикрытия','','Прус-Роскошный Роман Владимирович','','','','ВЕНТРАНС ООО ТЛК (ИНН 7817333232!!!)','Москва, проспект Мира, 222/2 - Самарская обл, г. Новокуйбышевск, ул. Лизы Чайкинй 5А ','','14.08.2026','14.08.2026',1,'Нет',-990000,'Смена','','Нет','          ','Экскаватор ZAUBERG E370',450000,'','','',450000,'','Безналичный',1,'',480,'','','','','','','','','0','','Савиток Олеся Анатольевна 8-985-150-11-85','Нет','Нет','000472546',450000],
    ['Савиток Олеся Анатольевна 8-985-150-11-85','08. БУЛЬДОГ ООО','Машина прикрытия','','Прус-Роскошный Роман Владимирович','','','','ВЕНТРАНС ООО ТЛК (ИНН 7817333232!!!)','Киржач, ул. Прибрежная - Владимир ул. Мира дом 8','','14.08.2026','14.08.2026',1,'Нет',-990000,'Смена','','Нет','          ','кран Xcmg xgc55 ',150000,'','','',150000,'','Безналичный',1,'',480,'','','','','','','','','0','','Савиток Олеся Анатольевна 8-985-150-11-85','Нет','Нет','000472547',150000]
  ];

  var report = [];

  // 1. Прикрывашки июнь-июль - в архивы (тот же raw-формат, что и Заказы_YYYY-MM)
  ...
  var augData = [HEADERS].concat(AUG_MISSING_ROWS);
  var parsedAug = parseOrdersRawRows(augData);
  var norm = ss.getSheetByName(ORDERS_NORM_SHEET);
  var existingRows = (norm && norm.getLastRow() > 1)
    ? norm.getRange(2, 1, norm.getLastRow() - 1, parsedAug.headers.length).getValues() : [];
  var merged = mergeNormalizedOrderRows_(existingRows, parsedAug.rows);
  if (!norm) norm = ss.insertSheet(ORDERS_NORM_SHEET);
  norm.clear();
  norm.getRange(1, 1, 1, parsedAug.headers.length).setValues([parsedAug.headers]).setFontWeight('bold');
  if (merged.length) {
    norm.getRange(2, 1, merged.length, parsedAug.headers.length).setValues(merged);
    norm.getRange(2, 31, merged.length, 10).setNumberFormat('#,##0');
  }
  norm.setFrozenRows(1);
  report.push(ORDERS_NORM_SHEET + ' (август, живой): было ' + existingRows.length + ', стало ' + merged.length +
    ' (+' + (merged.length - existingRows.length) + ')');

  Logger.log('✅ ' + report.join(' | '));
  Logger.log('Дальше запусти backfillMonthSummaries() - подхватит июнь/июль/август с новыми суммами.');
}
