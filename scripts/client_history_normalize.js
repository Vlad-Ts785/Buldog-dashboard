...
// отсеивались фильтром "не отдел тралов", вместе с выручкой И наличкой. Роль (менеджер vs
// логист) по имени не определить надёжно - добавлены В ОБА списка, только в этом файле
// (историческая мега-база) - не трогает текущую зарплату/live-фильтрацию в full_script_final.js,
// та работает с ТЕКУЩИМ составом и это отдельный вопрос.
const TRAL_MANAGERS = [
  ...
  'Рыщанов', 'Суркова',
  'Васёв', 'Горбачев', 'Каспарова', 'Свешников', 'Фидан', // бывшие сотрудники, см. комментарий выше
];
